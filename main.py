...
from kivymd.uix.button import  MDRectangleFlatButton, MDFloatingActionButton , MDRoundFlatButton, MDRaisedButton
...
class AdminLoginScreen(Screen):
    ...
    def toggle_password_visibility(self):
        self.ids.admin_password.password = not self.ids.admin_password.password
        self.ids.admin_password.focus = True  # To ensure the cursor position is updated
        ...
        try:
            ...
            if locations:
                for location in locations:
                    ...
                    card = MDCard(
                        orientation='vertical',
                        size_hint=(None, None),  # Use None for both width and height
                        size=(dp(400), dp(350)),
        ...
        try:
            ...
            if service_ids:  # Check if service_ids list is not empty
                ...
                if not service_provider_view_requests:
                    print("No Requests Found")  # Add this line for debugging
                    ...
                    admin_service_cards_layout.do_layout()  # Add this line
                    print("No Requests Label Added")  # Add this line
                    return
